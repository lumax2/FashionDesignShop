              ...
              <div class="box">
                ...
                <form method="post">
                  <table id="example2" class="table table-bordered table-hover">
                    <tr hidden="hidden">
                      <td>
                        <input type="text" name="moduleId" value="${module.moduleId }"/>
                      </td>
                    </tr>
                    <tr>
                      <td>模块名称:</td>
                      ...
                      <td>
                         <select name="parentModule.moduleId">
                          ...
                          <c:if test="${module.moduleId!=p.moduleId }">
                             <option value="${p.moduleId }" <c:if test="${module.parentModule.moduleId==p.moduleId }">selected="selected"</c:if>>${p.moduleName }</option>
                          </c:if>
