...
<%@include file="../head-less.jsp" %>          
	...
	<a href="#" onclick="formSubmit('tocreatemodule','_self');this.blur();">新增</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="#" onclick="formSubmit('toupdatemodule','_self');this.blur();">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="#" onclick="formSubmit('todeletemodule','_self');this.blur();">删除</a>

                  <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                      <th class="tableHeader"><input type="checkbox" name="selid" onclick="checkAll('moduleId',this)"></th>
                        <th class="tableHeader">序号</th>
                        <th class="tableHeader">模块名称</th>
                        <th class="tableHeader">上级模块</th>
                      </tr>
                    </thead>
                    <tbody>
                     <c:forEach items="${moduleList}" var="m" varStatus="status"> 
                      <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'"> 
                        ...
                        <td>${m.moduleName }</td>
                        <td>${m.parentModule.moduleName }</td>
                      </tr>
                </c:forEach> 
                  </table>
                  </form>
