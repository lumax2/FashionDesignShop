          ...
          <ul class="sidebar-menu">
            ...
            <li class=" active treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="#" onclick="formSubmit('torolemodule','_self');this.blur();"><i class="fa fa-circle-o"></i> 设置权限</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <div class="box">
                ...
                <form>
                  <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      <tr>
						<th class="tableHeader"><input type="checkbox" name="selid" onclick="checkAll('roleId',this)"></td>
                        <th class="tableHeader">角色id</th>
                        <th class="tableHeader">角色名称</th>
                      ...
                      <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'"> 
            			...
            			<tr>
                    		<td align="center" colspan="7">
                    			<a href="#" onclick="formSubmit('deleterole','_self');this.blur();"><i class="fa fa-circle-o"></i>删除</a>
                    		</td>
                    	</tr>
                    </tbody>
                  </table>
