              ...
              <div class="box">
               ...
               <form method="post">
                  <table id="example2" class="table table-bordered table-hover">
					...
					<tr>
						<td>订单金额：</td>
						<td><input name="orderMoney" type="text"  value="${order.orderMoney}"></td>
					</tr>
					<tr>
						<td>订单信息：</td>
							
						<td><textarea style="height:50px;width:100%" name="receiveInfo">${order.receiveInfo}</textarea></td>
					</tr>
					<tr>
						<td>支付状态：</td>
						<td>
							<input name="payState" type="radio" value="0" <c:if test="${order.payState==0}">checked="checked"</c:if>>未支付
							<input name="payState" type="radio" value="1" <c:if test="${order.payState==1}">checked="checked"</c:if>>已支付
						</td>
					</tr>
					<tr>
						<td>收货虚拟id：</td>
						<td><input name="userId" type="text" value="${order.userId}"></td>
					</tr>
					<tr>
						<td align="center"><a href="#" onclick="formSubmit('updateOrder','_self');this.blur();">保存</a></td>
