			...
			<div class="row">
				<div class="col-md-7">
					...
					<div class="head-btn wow fadeInLeft">
						...
						<a href="/toRegist.action" class="btn-default">注册</a>
					</div>
				</div> 
				...
				<div class="col-md-5">
					...
					<div class="signup-header wow fadeInUp">
						<h3 class="form-title text-center">欢 迎 回 到 FDS</h3>
						<form class="form-header" action="/login.action" role="form" method="POST" id="#">
							<div class="form-group">
								<input class="form-control input-lg" name="username" id="name" type="text" placeholder="请输入您的用户名" required>
							</div>
							<div class="form-group">
								<input class="form-control input-lg" name="password" id="password" type="password" placeholder="请输入您的密码" required>
							</div>
							<p><font size="4PX" style="font-weight:900; " color="red">${errorInfo }</font></p>
							<div class="form-group last">
								<input type="submit" class="btn btn-warning btn-block btn-lg" value="登陆">
							</div>
