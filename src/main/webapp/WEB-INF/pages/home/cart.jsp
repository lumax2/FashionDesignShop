...
<div class="container-fluid">
		...
		<div class="head-top">
			...
			<div class="col-md-12 h_menu4"  style="border-bottom: solid;border-top: solid;">
				<ul class="memenu black">
					  <li class="grid"><a  href="${pageContext.request.contextPath }/home.action#projects-container" style="font-weight: bolder;font-size: large;">主页</a></li>	
				      <li class="grid"><a  href="${pageContext.request.contextPath }/home.action#projects-container" style="font-weight: bolder;font-size: large;">男装</a></li>
				      <li class="grid"><a  href="${pageContext.request.contextPath }/home.action#projects-container" style="font-weight: bolder;font-size: large;">女装</a>
					  <li class="grid"><a  href="#" style="font-weight: bolder;font-size: large;">部落格</a></li>				
					  <li class="grid"><a  href="#" style="font-weight: bolder;font-size: large;">联系方式</a></li>
			  	</ul> 
			</div>
			<br/><br/><br/><br/>
	<div class="row-fluid">
	...
	<div class="row-fluid">
		<div class="span12">
			<form action="/order/toOrderAdd" method="post">
				<table width="100%">
					  <tr bgcolor="#5B5B5B">
						<!-- <td width="10%" align="center"><input name="allC" type="checkbox" value="" onclick="checkAll('prodC',this)" style="margin-left: 30px;"/> </td> -->
						<td width="10%"></td>
					  ...
					  <c:forEach items="${cartSession}" var="entry">
					  	...
					  	<tr bgcolor="F0F0F0">
							...
							<td width="16%" class="check" align="center">
								<input style="width:40px;color: black;" id="${entry.key.productId }" class="buyNum" type="text" value="${entry.value }" /> 
							...
							<td class="del" width="16%" align="center"><a href="#" style="color: black;">删除</a></td>
					  	</tr>
					  </c:forEach>
					  <tr>
							<td height="5"></td>
					  ...
					  <tr bgcolor="#5B5B5B">
						...
						<td id="toOrderAdd" width="16%" align="center" bgcolor="#CE0000"><a href="/order/toOrderAdd.action" style="font-weight: bolder;font-size: medium;color: white; text-decoration: none" >去结算</a></td>
					  </tr>
				</table>
				<!-- <button type="submit" style="width:100px;height:40px;background:#CE0000;margin-left: 1000px;" class="btn" onmouseover="this.style.backgroundColor='#FF0000';" onmouseout="this.style.backgroundColor='#CE0000';">
						<font style="font-weight: bolder;color: white;font-size: large;">去 结 算</font>
					 </button> -->
			</form>
			<br/><br/><br/>
		</div>
